/**
 * Algorithm Education Data
 *
 * Local copy of PLATFORM_EDUCATION data for frontend use.
 * This mirrors the shared package data for type safety and bundle optimization.
 *
 * @module components/molecules/algorithmEducationData
 */
...
export const PLATFORM_EDUCATION_DATA: Record<Platform, PlatformEducation> = {
    tiktok: {
        platform: 'tiktok',
        ...
        optimizationExplanations: [
            ...
            },
            {
                ...
                example: {
                    good: 'Son cümle başa bağlanıyor: "...ve işte bu yüzden bu bilgiyi..."',
